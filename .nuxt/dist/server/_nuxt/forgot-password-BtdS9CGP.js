...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div><footer class="absolute bottom-12 left-1/2 -translate-x-1/2 w-full text-center px-6" data-v-9070b843><p class="text-xs font-semibold text-slate-400" data-v-9070b843>© 2026 Society for Cellular Pathology Scientists of Nigeria</p></footer></div></div>`);
    };
  }
};
...
//# sourceMappingURL=forgot-password-BtdS9CGP.js.map
