...
import { ref, mergeProps, withCtx, createTextVNode, unref, createVNode, resolveDynamicComponent, useSSRContext } from "vue";
import { ssrRenderAttrs, ssrRenderClass, ssrRenderList, ssrRenderAttr, ssrInterpolate, ssrRenderComponent, ssrRenderVNode } from "vue/server-renderer";
import { useRouter } from "vue-router";
import { LucideArrowRight, LucideMicroscope, LucideGlobe, LucideDna, LucideShieldCheck, LucideCheck } from "lucide-vue-next";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></div></div><div class="mt-16 pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4" data-v-16c9bc07><p class="text-[9px] font-black text-white/20 uppercase tracking-[0.3em]" data-v-16c9bc07>© 2026 SCPSN Scientific Network. SECURE PORTAL ACCESS.</p><div class="flex gap-8" data-v-16c9bc07>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/signup",
...
//# sourceMappingURL=index-B92OaUQJ.js.map
