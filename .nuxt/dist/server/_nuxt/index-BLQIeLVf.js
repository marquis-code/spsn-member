...
import __nuxt_component_0$1 from "./index-Cngwfm37.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const renewalDate = computed(() => {
      if (user.value?.expiryDate) return new Date(user.value.expiryDate).toLocaleDateString(void 0, { year: "numeric", month: "long", day: "numeric" });
      return "Dec 31, 2026";
    });
    const metrics = [
...
//# sourceMappingURL=index-BLQIeLVf.js.map
