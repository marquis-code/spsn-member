...
import { _ as __nuxt_component_0, i as useRoute, d as useRouter, a as useCMS, c as useUser } from "../server.mjs";
import { mergeProps, unref, withCtx, createTextVNode, useSSRContext, ref, computed, openBlock, createBlock, createCommentVNode, createVNode, toDisplayString } from "vue";
...
import { u as useNotifications } from "./useNotifications-Dn8u0OVl.js";
import { _ as _export_sfc } from "./_plugin-vue_export-helper-1tPrXgE0.js";
import { _ as _sfc_main$2 } from "./ConfirmModal-D0gIV_87.js";
import { u as useChat } from "./useChat-Bdsdhj_f.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(cmsConfig)?.member?.portal?.sidebarLogo) {
        _push(`<img${ssrRenderAttr("src", unref(cmsConfig).member.portal.sidebarLogo)} class="w-full h-full object-cover" data-v-dc0de846>`);
      } else {
        _push(`<span data-v-dc0de846>${ssrInterpolate(unref(cmsConfig)?.member?.portal?.siteInitials || "SC")}</span>`);
      }
      _push(`</div><div data-v-dc0de846><span class="font-bold text-white text-xs block uppercase tracking-widest" data-v-dc0de846>${ssrInterpolate(unref(cmsConfig)?.member?.portal?.siteName || "Scientific Hub")}</span><p class="text-[10px] text-white/60 font-medium mt-0.5" data-v-dc0de846>${ssrInterpolate(unref(cmsConfig)?.member?.portal?.siteName ? "Member Portal" : "Society for Cellular Pathology")}</p></div></div></div><nav class="flex-1 overflow-y-auto py-8 px-4 space-y-1.5 custom-scrollbar" data-v-dc0de846><!--[-->`);
...
//# sourceMappingURL=dashboard-AOdQf5va.js.map
