  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_SideDrawer, {
        ...
        subtitle: "#" + ((_a = unref(selectedTicket)) == null ? void 0 : _a.id),
        ...
        footer: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            if (((_a2 = unref(selectedTicket)) == null ? void 0 : _a2.status) === "Open") {
            ...
            return [
              createVNode("div", { class: "flex gap-3" }, [
                ...
                ((_b = unref(selectedTicket)) == null ? void 0 : _b.status) === "Open" ? (openBlock(), createBlock("button", {
                  key: 0,
...
//# sourceMappingURL=support-Bz0bcah4.mjs.map
