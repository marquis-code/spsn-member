import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, computed, h, ref, hasInjectionContext, inject, onServerPrefetch, toRef, isRef, getCurrentInstance, defineAsyncComponent, unref, shallowRef, provide, shallowReactive, Suspense, Fragment, createElementBlock, cloneVNode, toValue, createApp, onErrorCaptured, createVNode, resolveDynamicComponent, reactive, effectScope, nextTick, mergeProps, withCtx, getCurrentScope, isReadonly, useSSRContext, isShallow, isReactive, toRaw } from 'file:///Users/marquis/scpsn/member/node_modules/vue/index.mjs';
import { $fetch as $fetch$1 } from 'file:///Users/marquis/scpsn/member/node_modules/ofetch/dist/node.mjs';
import { e as baseURL } from '../nitro/nitro.mjs';
import { createHooks } from 'file:///Users/marquis/scpsn/member/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file:///Users/marquis/scpsn/member/node_modules/unctx/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///Users/marquis/scpsn/member/node_modules/vue-router/vue-router.node.mjs';
import { defuFn, defu } from 'file:///Users/marquis/scpsn/member/node_modules/defu/dist/defu.mjs';
import { parseURL, encodePath, decodePath, hasProtocol, isScriptProtocol, joinURL, withQuery } from 'file:///Users/marquis/scpsn/member/node_modules/ufo/dist/index.mjs';
import { Icon, getIcon, loadIcon as loadIcon$1, _api, addAPIProvider, setCustomIconsLoader } from 'file:///Users/marquis/scpsn/member/node_modules/@iconify/vue/dist/iconify.mjs';
import { klona } from 'file:///Users/marquis/scpsn/member/node_modules/klona/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderAttrs } from 'file:///Users/marquis/scpsn/member/node_modules/vue/server-renderer/index.mjs';
import axios from 'file:///Users/marquis/scpsn/member/node_modules/axios/index.js';
import { getIconCSS } from 'file:///Users/marquis/scpsn/member/node_modules/@iconify/utils/lib/css/icon.js';
import { debounce } from 'file:///Users/marquis/scpsn/member/node_modules/perfect-debounce/dist/index.mjs';
import { u as useHead$1, h as headSymbol } from '../_/renderer.mjs';
import { sanitizeStatusCode, createError as createError$1, appendHeader } from 'file:///Users/marquis/scpsn/member/node_modules/h3/dist/index.mjs';
...
const _routes = [
  {
    name: "dashboard-abstracts",
    path: "/dashboard/abstracts",
    meta: { ...__nuxt_page_meta$a || {}, ...{ "middleware": "auth" } },
    component: () => import('./abstracts-DwLS2b38.mjs')
  },
  {
    name: "dashboard-chat",
    path: "/dashboard/chat",
    meta: { ...__nuxt_page_meta$9 || {}, ...{ "middleware": "auth" } },
    component: () => import('./chat-Ci4Q2TVU.mjs')
  },
  {
    name: "dashboard-library",
    path: "/dashboard/library",
    meta: { ...__nuxt_page_meta$8 || {}, ...{ "middleware": "auth" } },
    component: () => import('./library-DPiQSFEa.mjs')
  },
  {
    name: "dashboard-notifications",
    path: "/dashboard/notifications",
    meta: { ...__nuxt_page_meta$7 || {}, ...{ "middleware": "auth" } },
    component: () => import('./notifications-D6P26woQ.mjs')
  },
  {
    name: "dashboard-payments",
    path: "/dashboard/payments",
    meta: { ...__nuxt_page_meta$6 || {}, ...{ "middleware": "auth" } },
    component: () => import('./payments-5WgtK5XH.mjs')
  },
  {
    name: "dashboard-portfolio",
    path: "/dashboard/portfolio",
    meta: __nuxt_page_meta$5 || {},
    component: () => import('./portfolio-XZeIumTw.mjs')
  },
  {
    name: "dashboard-support",
    path: "/dashboard/support",
    meta: { ...__nuxt_page_meta$4 || {}, ...{ "middleware": "auth" } },
    component: () => import('./support-CijAJmqG.mjs')
  },
  {
    name: "dashboard",
    path: "/dashboard",
    meta: __nuxt_page_meta$3 || {},
    component: () => import('./index-Cd-8ZKaU.mjs')
  },
  {
    name: "forgot-password",
    path: "/forgot-password",
    meta: __nuxt_page_meta$2 || {},
    component: () => import('./forgot-password-BtdS9CGP.mjs')
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./login-CWRJ5Z8g.mjs')
  },
  {
    name: "reset-password",
    path: "/reset-password",
    meta: __nuxt_page_meta || {},
    component: () => import('./reset-password-BRwbsJt7.mjs')
  },
  {
    name: "signup",
    path: "/signup",
    component: () => import('./signup-C_YZJ6KV.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-CEblwd7v.mjs')
  }
];
...
const layouts = {
  auth: defineAsyncComponent(() => import('./auth-D2V_DEDS.mjs').then((m) => m.default || m)),
  chat: defineAsyncComponent(() => import('./chat-BB_pA7oW.mjs').then((m) => m.default || m)),
  dashboard: defineAsyncComponent(() => import('./dashboard-AOdQf5va.mjs').then((m) => m.default || m)),
  default: defineAsyncComponent(() => import('./default-CbwDyGRn.mjs').then((m) => m.default || m))
};
...
const $GATEWAY_ENDPOINT = "https://spsn-backend.onrender.com";
...
GATEWAY_ENDPOINT.interceptors.request.use((config) => {
  ...
  if (token2.value) {
    config.headers.Authorization = `Bearer ${token2.value}`;
  }
  return config;
});
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CSNCs6FC.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-Z55EOWv8.mjs'));
...
export { GATEWAY_ENDPOINT as G, __nuxt_component_0 as _, useCMS as a, useCustomToast as b, useUser as c, useRouter as d, entry_default as default, encodeRoutePath as e, useNuxtApp as f, useRuntimeConfig as g, nuxtLinkDefaults as h, useRoute as i, defineNuxtRouteMiddleware as j, useRequestEvent as k, navigateTo as n, resolveRouteObject as r, useHead as u };
