import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, inject, getCurrentInstance, defineAsyncComponent, defineComponent, h, computed, unref, shallowRef, provide, shallowReactive, ref, Suspense, Fragment, createApp, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, mergeProps, withCtx, getCurrentScope, toRef, nextTick, isReadonly, useSSRContext, isRef, isShallow, isReactive, toRaw } from 'file:///Users/mac/Documents/spsn/member/node_modules/vue/index.mjs';
import { $fetch as $fetch$1 } from 'file:///Users/mac/Documents/spsn/member/node_modules/ofetch/dist/node.mjs';
import { e as baseURL } from '../nitro/nitro.mjs';
import { createHooks } from 'file:///Users/mac/Documents/spsn/member/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file:///Users/mac/Documents/spsn/member/node_modules/unctx/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///Users/mac/Documents/spsn/member/node_modules/vue-router/vue-router.node.mjs';
import { defuFn, defu } from 'file:///Users/mac/Documents/spsn/member/node_modules/defu/dist/defu.mjs';
import { parseURL, encodePath, decodePath, hasProtocol, isScriptProtocol, joinURL, withQuery } from 'file:///Users/mac/Documents/spsn/member/node_modules/ufo/dist/index.mjs';
import { _api, addAPIProvider, setCustomIconsLoader } from 'file:///Users/mac/Documents/spsn/member/node_modules/@iconify/vue/dist/iconify.mjs';
import { klona } from 'file:///Users/mac/Documents/spsn/member/node_modules/klona/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderAttrs } from 'file:///Users/mac/Documents/spsn/member/node_modules/vue/server-renderer/index.mjs';
import { createError as createError$1, sanitizeStatusCode, appendHeader } from 'file:///Users/mac/Documents/spsn/member/node_modules/h3/dist/index.mjs';
...
const _routes = [
  {
    ...
    component: () => import('./abstracts-D6W4DMy7.mjs')
  },
  {
    name: "dashboard-library",
    path: "/dashboard/library",
    meta: __nuxt_page_meta$4 || {},
    component: () => import('./library-DGJQXTxH.mjs')
  },
  {
    name: "dashboard-payments",
    path: "/dashboard/payments",
    meta: { ...__nuxt_page_meta$3 || {}, ...{ "middleware": "auth" } },
    component: () => import('./payments-BMTzVf85.mjs')
  },
  {
    name: "dashboard-portfolio",
    path: "/dashboard/portfolio",
    meta: __nuxt_page_meta$2 || {},
    component: () => import('./portfolio-CXyWKGxM.mjs')
  },
  {
    name: "dashboard-support",
    path: "/dashboard/support",
    meta: { ...__nuxt_page_meta$1 || {}, ...{ "middleware": "auth" } },
    component: () => import('./support-Bz0bcah4.mjs')
  },
  {
    name: "dashboard",
    path: "/dashboard",
    meta: __nuxt_page_meta || {},
    component: () => import('./index-BLQIeLVf.mjs')
  },
  {
    name: "login",
    path: "/login",
    component: () => import('./login-DCHv32dg.mjs')
  },
  {
    name: "signup",
    path: "/signup",
    component: () => import('./signup-9iMVQp54.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-B92OaUQJ.mjs')
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./index-Cngwfm37.mjs').then((r) => r["default"] || r.default || r));
...
const layouts = {
  dashboard: defineAsyncComponent(() => import('./dashboard-CcXOWKmc.mjs').then((m) => m.default || m)),
  default: defineAsyncComponent(() => import('./default-P1mc38mw.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DjfTbHse.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-vamqUrBt.mjs'));
...
export { useRouter as a, useNuxtApp as b, useRuntimeConfig as c, defineNuxtRouteMiddleware as d, entry_default as default, encodeRoutePath as e, nuxtLinkDefaults as f, useRequestEvent as g, useAppConfig as h, asyncDataDefaults as i, createError as j, navigateTo as n, resolveRouteObject as r, useRoute as u };
