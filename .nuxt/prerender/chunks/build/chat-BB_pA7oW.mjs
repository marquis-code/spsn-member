...
import { c as useUser, _ as __nuxt_component_0$1 } from './server.mjs';
import { useSSRContext, computed, mergeProps, withCtx, createVNode, unref, toDisplayString, openBlock, createBlock } from 'file:///Users/marquis/scpsn/member/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderAttr, ssrRenderSlot } from 'file:///Users/marquis/scpsn/member/node_modules/vue/server-renderer/index.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            _push2(`<div class="text-right hidden sm:block" data-v-35d0fc7d${_scopeId}><p class="text-xs font-bold" data-v-35d0fc7d${_scopeId}>${ssrInterpolate(((_a = unref(user)) == null ? void 0 : _a.fullName) || "Practitioner")}</p><p class="text-[10px] text-white/50" data-v-35d0fc7d${_scopeId}>${ssrInterpolate(((_b = unref(user)) == null ? void 0 : _b.category) || "Member")}</p></div><div class="w-10 h-10 rounded-xl bg-white/10 border border-white/20 flex items-center justify-center overflow-hidden" data-v-35d0fc7d${_scopeId}>`);
            if ((_c = unref(user)) == null ? void 0 : _c.profilePicture) {
            ...
            return [
              createVNode("div", { class: "text-right hidden sm:block" }, [
                createVNode("p", { class: "text-xs font-bold" }, toDisplayString(((_d = unref(user)) == null ? void 0 : _d.fullName) || "Practitioner"), 1),
                createVNode("p", { class: "text-[10px] text-white/50" }, toDisplayString(((_e = unref(user)) == null ? void 0 : _e.category) || "Member"), 1)
              ]),
              createVNode("div", { class: "w-10 h-10 rounded-xl bg-white/10 border border-white/20 flex items-center justify-center overflow-hidden" }, [
                ((_f = unref(user)) == null ? void 0 : _f.profilePicture) ? (openBlock(), createBlock("img", {
                  key: 0,
...
//# sourceMappingURL=chat-BB_pA7oW.mjs.map
