...
import { ref, reactive, mergeProps, unref, withCtx, createVNode, createTextVNode, computed, defineComponent, useSlots, useId, useSSRContext } from 'file:///Users/mac/Documents/spsn/member/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderStyle, ssrRenderList, ssrRenderAttr, ssrIncludeBooleanAttr, ssrRenderClass, ssrRenderSlot } from 'file:///Users/mac/Documents/spsn/member/node_modules/vue/server-renderer/index.mjs';
import { LucideCheck, LucideGlobe, LucideArrowLeft, LucideCheckCircle, LucideUpload, LucideArrowRight, LucideChevronDown, LucidePhone } from 'file:///Users/mac/Documents/spsn/member/node_modules/lucide-vue-next/dist/cjs/lucide-vue-next.js';
...
const useFormValidation = (form) => {
  ...
  const validateStep = (step) => {
    ...
    let isValid = true;
    if (step === 1) {
      if (!((_a = form.fullName) == null ? void 0 : _a.trim())) {
        errors.value.fullName = "Full Name is required for official certification";
        isValid = false;
      }
      if (!((_b = form.email) == null ? void 0 : _b.trim()) || !validateEmail(form.email)) {
      ...
      if (!((_c = form.phoneNumber) == null ? void 0 : _c.trim()) || !validatePhone(form.phoneNumber)) {
        errors.value.phoneNumber = "A valid contact number with country code is required";
        isValid = false;
      }
      if (!((_d = form.organization) == null ? void 0 : _d.trim())) {
    ...
    if (step === 3) {
      if (!((_f = (_e = form.professionalProfile) == null ? void 0 : _e.bio) == null ? void 0 : _f.trim()) || form.professionalProfile.bio.length < 50) {
        errors.value.bio = "Scientific biography must be at least 50 characters";
        isValid = false;
      }
      if (!((_g = form.refereeName) == null ? void 0 : _g.trim())) {
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</p><p class="text-xs text-slate-300 font-bold" data-v-5f646ddc> \xA9 2026 Society for Cellular Pathology Scientists of Nigeria </p></footer></div></main></div>`);
    };
  }
};
...
//# sourceMappingURL=signup-9iMVQp54.mjs.map
