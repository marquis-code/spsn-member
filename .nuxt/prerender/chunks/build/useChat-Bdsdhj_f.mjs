import { computed, ref } from 'file:///Users/marquis/scpsn/member/node_modules/vue/index.mjs';
    ...
    messages: [
      {
        id: "m5",
        senderId: "member-3",
        text: "Check out these morphology samples.",
        time: "Mon",
        isMe: false,
        status: "read",
        attachments: [
...
const useChat = () => {
  ...
  const sendMessage = (chatId, text, attachments) => {
    ...
    if (chat && ((text == null ? void 0 : text.trim()) || attachments && attachments.length > 0)) {
      const newMessage = {
...
export { useChat as u };
//# sourceMappingURL=useChat-Bdsdhj_f.mjs.map
