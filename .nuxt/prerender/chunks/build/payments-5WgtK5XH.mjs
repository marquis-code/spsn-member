...
import { ref, mergeProps, unref, withCtx, openBlock, createBlock, createVNode, toDisplayString, createTextVNode, createCommentVNode, useSSRContext } from 'file:///Users/marquis/scpsn/member/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrInterpolate, ssrRenderComponent, ssrRenderList, ssrRenderClass } from 'file:///Users/marquis/scpsn/member/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500" }, _attrs))}><div class="flex items-center justify-between"><div><h1 class="text-3xl font-bold text-slate-800 tracking-tight">${ssrInterpolate(((_d = (_c = (_b = (_a = unref(cmsConfig)) == null ? void 0 : _a.member) == null ? void 0 : _b.pages) == null ? void 0 : _c.payments) == null ? void 0 : _d.title) || "Payments")}</h1><p class="text-slate-500 font-medium mt-1 text-sm">${ssrInterpolate(((_h = (_g = (_f = (_e = unref(cmsConfig)) == null ? void 0 : _e.member) == null ? void 0 : _f.pages) == null ? void 0 : _g.payments) == null ? void 0 : _h.subtitle) || "Manage your membership dues, conference tickets, and transaction history.")}</p></div><button class="btn-premium flex items-center gap-2">`);
      ...
      _push(ssrRenderComponent(_component_SideDrawer, {
        ...
        subtitle: (_i = selectedTransaction.value) == null ? void 0 : _i.id,
        size: "md",
        onClose: ($event) => isDrawerOpen.value = false
      }, {
        footer: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex gap-3"${_scopeId}><button class="flex-1 py-3 bg-white border border-slate-200 hover:border-slate-300 text-slate-600 rounded-xl text-xs font-bold transition-all lowercase"${_scopeId}>close</button><button class="flex-1 py-3 bg-[#003366] text-white rounded-xl text-xs font-bold hover:bg-[#002244] transition-all flex justify-center items-center gap-2 lowercase"${_scopeId}>`);
            ...
            return [
              createVNode("div", { class: "flex gap-3" }, [
                createVNode("button", {
                  ...
                  class: "flex-1 py-3 bg-white border border-slate-200 hover:border-slate-300 text-slate-600 rounded-xl text-xs font-bold transition-all lowercase"
                }, "close", 8, ["onClick"]),
                createVNode("button", {
                  onClick: downloadReceipt,
                  class: "flex-1 py-3 bg-[#003366] text-white rounded-xl text-xs font-bold hover:bg-[#002244] transition-all flex justify-center items-center gap-2 lowercase"
                }, [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (selectedTransaction.value) {
              _push2(`<div class="space-y-8"${_scopeId}><div class="bg-slate-50 p-6 rounded-2xl rounded-tl-none border border-slate-100"${_scopeId}><p class="text-[10px] font-black text-slate-400 lowercase mb-2"${_scopeId}>amount paid</p><h2 class="text-4xl font-extrabold text-[#003366] tracking-tight"${_scopeId}>$${ssrInterpolate(selectedTransaction.value.amount.toFixed(2))}</h2><div class="mt-4 inline-flex items-center gap-2 px-4 py-1.5 bg-emerald-50 text-emerald-600 rounded-lg text-xs font-bold border border-emerald-100"${_scopeId}>`);
              _push2(ssrRenderComponent(_component_Icon, {
                name: "lucide:check-circle",
                size: "14"
              }, null, _parent2, _scopeId));
              _push2(` successful payment </div></div><div class="space-y-6"${_scopeId}><h4 class="text-sm font-bold text-slate-800 border-b border-slate-100 pb-2 lowercase"${_scopeId}>invoice summary</h4><div class="grid grid-cols-2 gap-y-4"${_scopeId}><div${_scopeId}><p class="text-[10px] font-black text-slate-400 mb-1 lowercase"${_scopeId}>date</p><p class="text-sm font-bold text-slate-800"${_scopeId}>${ssrInterpolate(selectedTransaction.value.date)}</p></div><div${_scopeId}><p class="text-[10px] font-black text-slate-400 mb-1 lowercase"${_scopeId}>payment method</p><p class="text-sm font-bold text-slate-800 flex items-center gap-2"${_scopeId}>`);
              _push2(ssrRenderComponent(_component_Icon, {
                name: "lucide:credit-card",
                size: "16",
                class: "text-slate-400"
              }, null, _parent2, _scopeId));
              _push2(` \u2022\u2022\u2022\u2022 ${ssrInterpolate(selectedTransaction.value.cardLast4)}</p></div><div class="col-span-2"${_scopeId}><p class="text-[10px] font-black text-slate-400 mb-1 lowercase"${_scopeId}>description</p><p class="text-sm font-bold text-slate-800"${_scopeId}>${ssrInterpolate(selectedTransaction.value.description)}</p></div></div></div></div>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
            return [
              selectedTransaction.value ? (openBlock(), createBlock("div", {
                key: 0,
                class: "space-y-8"
              }, [
                createVNode("div", { class: "bg-slate-50 p-6 rounded-2xl rounded-tl-none border border-slate-100" }, [
                  createVNode("p", { class: "text-[10px] font-black text-slate-400 lowercase mb-2" }, "amount paid"),
                  createVNode("h2", { class: "text-4xl font-extrabold text-[#003366] tracking-tight" }, "$" + toDisplayString(selectedTransaction.value.amount.toFixed(2)), 1),
                ...
                createVNode("div", { class: "space-y-6" }, [
                  createVNode("h4", { class: "text-sm font-bold text-slate-800 border-b border-slate-100 pb-2 lowercase" }, "invoice summary"),
                  createVNode("div", { class: "grid grid-cols-2 gap-y-4" }, [
                    createVNode("div", null, [
                      createVNode("p", { class: "text-[10px] font-black text-slate-400 mb-1 lowercase" }, "date"),
                      createVNode("p", { class: "text-sm font-bold text-slate-800" }, toDisplayString(selectedTransaction.value.date), 1)
                    ]),
                    createVNode("div", null, [
                      createVNode("p", { class: "text-[10px] font-black text-slate-400 mb-1 lowercase" }, "payment method"),
                      createVNode("p", { class: "text-sm font-bold text-slate-800 flex items-center gap-2" }, [
                        ...
                        createTextVNode(" \u2022\u2022\u2022\u2022 " + toDisplayString(selectedTransaction.value.cardLast4), 1)
                      ])
                    ]),
                    createVNode("div", { class: "col-span-2" }, [
                      createVNode("p", { class: "text-[10px] font-black text-slate-400 mb-1 lowercase" }, "description"),
                      createVNode("p", { class: "text-sm font-bold text-slate-800" }, toDisplayString(selectedTransaction.value.description), 1)
                    ])
                  ])
                ])
...
//# sourceMappingURL=payments-5WgtK5XH.mjs.map
