...
import { ref, mergeProps, withCtx, createTextVNode, computed, watch, createVNode, toDisplayString, useSSRContext } from 'file:///Users/marquis/scpsn/member/node_modules/vue/index.mjs';
...
import { _ as __nuxt_component_0$2, i as useRoute } from './server.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></div></div><div class="mt-20 pt-10 border-t border-slate-50 flex flex-col md:flex-row items-center justify-between gap-6" data-v-39c047d8><p class="text-xs font-medium text-slate-400" data-v-39c047d8>\xA9 2026 Society for Cellular Pathology Scientists of Nigeria \u2022 All Rights Reserved.</p><div class="flex gap-8" data-v-39c047d8>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/signup",
...
//# sourceMappingURL=index-CEblwd7v.mjs.map
