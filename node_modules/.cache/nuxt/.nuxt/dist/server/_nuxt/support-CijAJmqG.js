  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_SideDrawer, {
        ...
        subtitle: "#" + selectedTicket.value?.id,
          ...
          if (_push2) {
            ...
            return [
              createVNode("div", { class: "flex gap-3" }, [
                ...
                selectedTicket.value?.status === "Open" ? (openBlock(), createBlock("button", {
                  key: 0,
...
//# sourceMappingURL=support-CijAJmqG.js.map
