...
import { G as GATEWAY_ENDPOINT, c as useUser, b as useCustomToast, a as useCMS, _ as __nuxt_component_0 } from "../server.mjs";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-slate-50 flex font-sans selection:bg-brand-cyan/20 overflow-hidden" }, _attrs))} data-v-a5a697c5><div class="hidden lg:flex lg:w-1/2 relative bg-brand-dark items-center justify-center p-20 overflow-hidden" data-v-a5a697c5><div class="absolute inset-0 opacity-40" data-v-a5a697c5><img${ssrRenderAttr("src", unref(cmsConfig)?.member?.portal?.loginBg || "/images/hero/1.png")} class="w-full h-full object-cover animate-pulse duration-[10000ms]" data-v-a5a697c5></div><div class="absolute inset-0 bg-gradient-to-tr from-[#033958] via-transparent to-transparent" data-v-a5a697c5></div><div class="relative z-10 space-y-12 animate-in fade-in slide-in-from-bottom-12" data-v-a5a697c5><div class="h-20 w-20 bg-white rounded-3xl flex items-center justify-center text-[#033958] font-black text-3xl" data-v-a5a697c5>${ssrInterpolate(unref(cmsConfig)?.global?.siteName ? unref(cmsConfig).global.siteName.split(" ").map((n) => n[0]).join("").substring(0, 2) : "SC")}</div><div class="space-y-6" data-v-a5a697c5><h1 class="text-6xl font-black text-white tracking-tighter leading-none" data-v-a5a697c5> Welcome <br data-v-a5a697c5> <span class="text-brand-cyan" data-v-a5a697c5>Back</span>. </h1><p class="text-xl text-white/50 font-medium max-w-md leading-relaxed" data-v-a5a697c5> Sign in to access your ${ssrInterpolate(unref(cmsConfig)?.global?.siteName || "SCPSN")} account. </p></div><div class="flex items-center gap-6" data-v-a5a697c5><div class="flex -space-x-3" data-v-a5a697c5><!--[-->`);
      ssrRenderList(4, (i) => {
...
//# sourceMappingURL=login-CWRJ5Z8g.js.map
