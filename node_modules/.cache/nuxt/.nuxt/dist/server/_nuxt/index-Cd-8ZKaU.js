...
import { a as useCMS, _ as __nuxt_component_0$1, c as useUser } from "../server.mjs";
import { computed, ref, mergeProps, unref, withCtx, createTextVNode, useSSRContext } from "vue";
import { ssrRenderAttrs, ssrRenderStyle, ssrInterpolate, ssrRenderComponent, ssrRenderClass, ssrIncludeBooleanAttr, ssrRenderList } from "vue/server-renderer";
import "./useLibrary-CnJtHw-h.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="relative z-10 space-y-6" data-v-5aac24a3><div class="inline-flex items-center gap-3 px-4 py-2 bg-white/10 backdrop-blur-md rounded-full border border-white/10" data-v-5aac24a3><span class="w-1.5 h-1.5 bg-emerald-400 rounded-full animate-pulse" data-v-5aac24a3></span><span class="text-xs font-bold lowercase" data-v-5aac24a3>scientific network active</span></div><h1 class="text-4xl font-bold tracking-tight leading-none" data-v-5aac24a3>${ssrInterpolate(unref(cmsConfig)?.member?.portal?.welcomeTitle || "Welcome Back,")} <br data-v-5aac24a3> <span class="text-brand-cyan" data-v-5aac24a3>${ssrInterpolate(unref(user)?.fullName?.split(" ")[0] || "Practitioner")}</span></h1><p class="text-white/80 text-sm font-medium max-w-md leading-relaxed" data-v-5aac24a3>${ssrInterpolate(unref(cmsConfig)?.member?.portal?.welcomeSubtitle || "Your credentials have been re-validated for the current diagnostic cycle. You have access to the latest pathological archives.")}</p><div class="flex items-center gap-6 pt-4" data-v-5aac24a3>`);
      ...
      _push(`</div></div></div><div class="bg-white rounded-[2rem] border border-slate-200 p-6 lg:p-10 flex flex-col justify-between" data-v-5aac24a3><div class="space-y-4" data-v-5aac24a3><span class="text-xs font-bold text-slate-400 lowercase" data-v-5aac24a3>membership identity</span><div class="flex items-center justify-between" data-v-5aac24a3><h3 class="text-2xl font-bold text-[#003366] tracking-tight leading-none" data-v-5aac24a3>${ssrInterpolate(unref(user)?.category || "Professional")}</h3><div class="${ssrRenderClass([unref(statusClass), "px-3 py-1 rounded-lg text-xs font-bold"])}" data-v-5aac24a3>${ssrInterpolate(unref(user)?.status || "Active")}</div></div><div class="pt-6 space-y-3" data-v-5aac24a3><div class="flex justify-between items-center text-xs font-bold" data-v-5aac24a3><span class="text-slate-400 lowercase" data-v-5aac24a3>renewal date</span><span class="text-slate-800" data-v-5aac24a3>${ssrInterpolate(unref(renewalDate))}</span></div><div class="h-2 bg-slate-100 rounded-full overflow-hidden" data-v-5aac24a3><div style="${ssrRenderStyle({ width: "75%" })}" class="h-full bg-brand-cyan" data-v-5aac24a3></div></div><p class="text-xs text-slate-400 font-medium" data-v-5aac24a3>75% of membership cycle remaining</p></div></div><button${ssrIncludeBooleanAttr(unref(isDownloading)) ? " disabled" : ""} class="w-full mt-6 py-4 bg-slate-50 border border-slate-200 rounded-2xl text-sm font-bold text-[#003366] hover:bg-slate-100 transition-all flex items-center justify-center gap-3 disabled:opacity-50" data-v-5aac24a3>`);
      ...
      _push(`<!--]--></div></div><div class="space-y-6" data-v-5aac24a3><h3 class="text-sm font-bold text-slate-500 lowercase" data-v-5aac24a3>quick support</h3><div class="bg-white p-6 lg:p-8 rounded-[2rem] border border-slate-200 space-y-6" data-v-5aac24a3><div class="space-y-2" data-v-5aac24a3><h4 class="text-sm font-bold text-[#003366]" data-v-5aac24a3>${ssrInterpolate(unref(cmsConfig)?.member?.portal?.announcementTitle || "Scientific Abstract Due")}</h4><p class="text-xs text-slate-500 font-medium leading-relaxed" data-v-5aac24a3>${ssrInterpolate(unref(cmsConfig)?.member?.portal?.announcementText || "The International Scientific Congress abstract submission is currently open for members.")}</p></div>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: unref(cmsConfig)?.member?.portal?.announcementLink || "/dashboard/abstracts",
...
//# sourceMappingURL=index-Cd-8ZKaU.js.map
